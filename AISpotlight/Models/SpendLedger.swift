...
nonisolated enum SpendLedger {
    ...
    static let container: ModelContainer = {
        ...
        let url = ChatStore.baseDirectory.appendingPathComponent("AISpotlightSpend.store")
    ...
    private static let queue = DispatchQueue(label: "AISpotlight.SpendLedger", qos: .utility)

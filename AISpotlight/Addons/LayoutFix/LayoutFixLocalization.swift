...
enum LayoutFixStrings {
    static let table: [String: [AppLanguage: String]] = [
        ...
        "lf.debug.footer": [
            .english: "Logs each finished word and the decision to ~/Library/Logs/AISpotlight-LayoutFix.log. Turn on to diagnose, off for daily use.",
            .spanish: "Registra cada palabra y la decisión en ~/Library/Logs/AISpotlight-LayoutFix.log. Actívalo para diagnosticar.",
            .russian: "Пишет каждое слово и решение в ~/Library/Logs/AISpotlight-LayoutFix.log. Включай для диагностики."
        ],

...
enum WorldTimeStrings {
    static let table: [String: [AppLanguage: String]] = [
        ...
        "wt.pin": [
            .english: "Keep the panel open when you click away",
            .spanish: "Mantener el panel abierto al cambiar de foco",
            .russian: "Оставлять панель открытой при смене фокуса"
        ],
        "wt.unpin": [
            .english: "Close the panel when you click away",
            .spanish: "Cerrar el panel al cambiar de foco",
            .russian: "Закрывать панель при смене фокуса"
        ],
    ]
}

...
struct ThemePalette {
    ...
    static let blueprintDark = ThemePalette(
        ...
        placeholderColor: rgba(150, 215, 255, 0.4),
    ...
    static let blueprintLight = ThemePalette(
        ...
        placeholderColor: rgba(15, 90, 150, 0.45),
    ...
    static let terminalDark = ThemePalette(
        ...
        placeholderColor: rgba(120, 255, 160, 0.5),
    ...
    static let terminalLight = ThemePalette(
        ...
        placeholderColor: rgba(10, 90, 40, 0.5),
    ...
    static let synthwaveDark = ThemePalette(
        ...
        placeholderColor: rgba(255, 180, 220, 0.45),
    ...
    static let synthwaveLight = ThemePalette(
        ...
        placeholderColor: rgba(190, 30, 110, 0.4),
    ...
    static let sakuraDark = ThemePalette(
        ...
        placeholderColor: rgba(255, 190, 215, 0.45),
    ...
    static let sakuraLight = ThemePalette(
        ...
        placeholderColor: rgba(190, 70, 115, 0.45),
    ...
    static let pastelDark = ThemePalette(
        ...
        placeholderColor: rgba(215, 195, 255, 0.5),
    ...
    static let pastelLight = ThemePalette(
        ...
        placeholderColor: rgba(120, 85, 180, 0.5),
    ...
    static let halloweenDark = ThemePalette(
        ...
        placeholderColor: rgba(255, 190, 130, 0.45),
    ...
    static let halloweenLight = ThemePalette(
        ...
        placeholderColor: rgba(150, 70, 20, 0.5),
    ...
    static let diaDark = ThemePalette(
        ...
        placeholderColor: rgba(255, 210, 120, 0.45),
    ...
    static let diaLight = ThemePalette(
        ...
        placeholderColor: rgba(170, 80, 10, 0.5),
